...
def perform_action():
    ...
    if option == 1:
        import web.balance
        messagebox.showinfo("Service", "Cash Balance selected.")
    elif option == 2:
        import web.withdrawal
        messagebox.showinfo("Service", "Cash Operation selected.")
    elif option == 3:
        import web.transfer
...
options = ["1 = CASH BALANCE", "2 = CASH WITHDRAWAL/ DEPSOIT", "3 = MONEY TRANSFER", "4 = Logout"]
option_labels = []
